...
- Change default integration test region from `East US` to `Australia East` due to
  quota limitations.
- Removed MacOS-11 testing from build pipeline because it is no longer supported by Microsoft
  managed Azure DevOps images.
